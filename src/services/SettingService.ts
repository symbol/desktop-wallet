...
export class SettingService {
    ...
    public getProfileSettings(profileName: string, generationHash: string): SettingsModel {
        const storedData = this.storage.get() || {};
        return {
            ...this.createDefaultSettingsModel(profileName, generationHash),
            ...(storedData[profileName] || {}),
        };
    }

    public changeProfileSettings(profileName: string, newConfigs: any, generationHash: string): SettingsModel {
        const storedData = this.storage.get() || {};
        storedData[profileName] = {
            ...this.getProfileSettings(profileName, generationHash),
            ...newConfigs,
        };
    ...
    public createDefaultSettingsModel(profileName: string, generationHash: string): SettingsModel {
        ...
        return new SettingsModel(profileName, language, feesConfig.slowest, '', networkConfig[generationHash].explorerUrl);
    }
