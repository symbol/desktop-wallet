...
import { networkConfig, defaultGenerationHashes } from '@/config';

export const OfflineUrl = 'http://mock:3000';

export const OfflineGenerationHash = {
    [NetworkType.TEST_NET]: defaultGenerationHashes.TEST_NET,
...
export const OfflineNetworkProperties = {
    [NetworkType.TEST_NET]: new NetworkConfiguration(
        new NetworkProperties(
            ...
            defaultGenerationHashes.TEST_NET,
            networkConfig[defaultGenerationHashes.TEST_NET].networkConfigurationDefaults.epochAdjustment + 's',
        ),
        new ChainProperties(
            true,
            true,
            networkConfig[defaultGenerationHashes.TEST_NET].networkConfigurationDefaults.currencyMosaicId,
            networkConfig[defaultGenerationHashes.TEST_NET].networkConfigurationDefaults.harvestingMosaicId,
            networkConfig[defaultGenerationHashes.TEST_NET].networkConfigurationDefaults.blockGenerationTargetTime + 's',
            '3000',
            '180',
            '5',
            '0',
            ...
            `${networkConfig[defaultGenerationHashes.TEST_NET].networkConfigurationDefaults.maxMosaicAtomicUnits}`,
            "10'000'000'000",
            "50'000'000'000'000",
            "3'000'000'000'000",
            '720',
    ...
    [NetworkType.MAIN_NET]: new NetworkConfiguration(
        new NetworkProperties(
            ...
            OfflineGenerationHash[defaultGenerationHashes.MAIN_NET],
            networkConfig[defaultGenerationHashes.MAIN_NET].networkConfigurationDefaults.epochAdjustment + 's',
        ),
        new ChainProperties(
            true,
            true,
            networkConfig[defaultGenerationHashes.MAIN_NET].networkConfigurationDefaults.currencyMosaicId,
            networkConfig[defaultGenerationHashes.MAIN_NET].networkConfigurationDefaults.harvestingMosaicId,
            networkConfig[defaultGenerationHashes.MAIN_NET].networkConfigurationDefaults.blockGenerationTargetTime + 's',
            '3000',
            '180',
            '5',
            '0',
            ...
            "7'831'975'436'000'000",
            "9'000'000'000'000'000",
            `${networkConfig[defaultGenerationHashes.MAIN_NET].networkConfigurationDefaults.maxMosaicAtomicUnits}`,
            "10'000'000'000",
            "50'000'000'000'000",
            "3'000'000'000'000",
            "3'000'000'000'000",
...
export const OfflineNetworkCurrencies = (genHash: string): NetworkCurrencies => {
    const publicCurrency = new Currency({
        ...
        supplyMutable: false,
        restrictable: false,
        mosaicId: new MosaicId(networkConfig[genHash].networkConfigurationDefaults.currencyMosaicId),
    });
