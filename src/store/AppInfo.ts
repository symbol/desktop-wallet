...
export default {
  ...
  getters: {
    ...
    fetchingTransactons: (state) => state.fetchingTransactons,
  },
  mutations: {
    ...
    setFetchingTransactions: (state, bool: boolean) => Vue.set(state, 'fetchingTransactons', bool),
  },
  actions: {
