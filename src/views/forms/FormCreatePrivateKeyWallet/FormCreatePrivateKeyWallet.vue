                    ...
                    <div class="form-line-container form-row">
                        <div class="flex-container mt-3">
                            ...
                            <button type="submit" class="button-style validation-button" @click="handleSubmit(submit)">
                                <span>{{ $t('import_private_key') }}</span>
                            </button>
                        </div>
                    </div>
                </form>
...
<script lang="ts">
import { FormCreatePrivateKeyWalletTs } from './FormCreatePrivateKeyWalletTs';
export default class FormProfileCreation extends FormCreatePrivateKeyWalletTs {}
</script>
