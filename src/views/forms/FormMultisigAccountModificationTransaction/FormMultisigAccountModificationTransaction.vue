            ...
            <form onsubmit="event.preventDefault()">
                ...
                <FormRow>
                    <template v-slot:label>
                        <div v-if="multisigOperationType === 'conversion'" style="padding-top:0.15rem;">{{ $t('form_label_account_to_be_converted') }}:</div>
                        <div v-else style="padding-top:0.15rem;">{{ $t('form_label_multisig_account') }}:</div>
                    </template>
                    <template v-slot:inputs>
