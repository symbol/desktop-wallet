...
export default class CreateProfileTs extends Vue {
  ...
  public getCurrentStep(): number {
    switch(this.$route.name) {
      default:
      case 'profiles.createProfile.info': return 0
      case 'profiles.createProfile.generateMnemonic': return 1
      case 'profiles.createProfile.showMnemonic': return 2
      case 'profiles.createProfile.verifyMnemonic': return 3
      case 'profiles.createProfile.finalize': return 4
    }
  }
