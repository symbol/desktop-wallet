...
export default class ImportPrivateKeyTs extends Vue {
   ...
   * @var {string[]}
   */
  public StepBarTitleList = ['Create_Profile', 'import_private_key', 'Finish']
  ...
  public getCurrentStep(): number {
    switch (this.$route.name) {
      default:
      case 'accounts.importPrivateKey.fillInfo':
        return 0
      case 'accounts.importPrivateKey.input':
        return 1
      case 'accounts.importPrivateKey.finalize':
        return 2
    }
  }
