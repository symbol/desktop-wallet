...
export default class ImportProfileTs extends Vue {
  ...
  public getCurrentStep(): number {
    switch(this.$route.name) {
      default:
      case 'profiles.importProfile.info': return 0
      case 'profiles.importProfile.importMnemonic': return 1
      case 'profiles.importProfile.walletSelection': return 2
      case 'profiles.importProfile.finalize': return 3
    }
  }
