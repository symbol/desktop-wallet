        ...
        <div class="right-container">
            ...
            <div class="address-list-container radius scroll">
                <div class="address-list">
                    ...
                    <div class="radius">
                        <div v-for="index in selectedAccounts" :key="index" class="table-item pointer" @click="onRemoveAddress(index)">
                            <span class="address-id"> {{ index + 1 }} </span>
            ...
            <div class="button-container flex-container">
                <button class="button-style info-button back-create-button fat-button" @click="previous">
                    {{ $t('previous') }}
                </button>
                <button class="button-style validation-create-button fat-button" @click="submit">
                    {{ $t('next') }}
                </button>
            </div>
        </div>
